...
namespace CHARACTERS
{
    public class CharacterSpriteLayer
    {
        ...
        // Coroutine that is used to transition the layer. If this is not null, then the layer is transitioning.
        ...
        // Create a new renderer for the layer. This will be used to transition the sprite to a new sprite. 
        // The old renderer will be disabled and the new one will be enabled.
        ...
        // Level the alpha of the layer to 1. This will also level the alpha of the old renderers to 0.
        ...
        {
            // Set the color of the new renderer to the new color
            ...
            {
                // Lerp the color of the new renderer to the new color
        ...
        // incase of need layer specific flipping control
        ...
        {
            float xScale = faceLeft ? 1 : -1; // 1 for left(character default orientation), -1 for right
