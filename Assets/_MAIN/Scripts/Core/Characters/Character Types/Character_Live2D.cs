...
namespace CHARACTERS
{
    public class Character_Live2D : Character
    {
        ...
        // set char expression = index number of expression inden in {anyChar}.expression List
        ...
        // in case of using by the expression own name to set the char expression
        ...
        public override IEnumerator ShowingOrHiding(bool show, float speedMultiplier = 1f)
        {
            ...
            {
                // remove spd multiplier if something is wrong
        ...
        public override IEnumerator FaceDirection(bool faceleft, float speedMultiplier, bool immediate)
        {
            ...
            // default orientation is left = 1, right = -1
            ...
            // Destroy the old renderers
            // r = oldRenderers.Where(r => r.Opacity == 0).ToList();
